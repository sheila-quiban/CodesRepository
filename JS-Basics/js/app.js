...
$("#select_model").change(function() {
	...
	if (select_option == "Multi-Layer Perceptron (MLP)") {
		modelName = "digitrecognizermlp";

	} else if (select_option == "Convolutional Neural Network (CNN)") {
...
async function loadModel(modelName) {
  ...
  //model = await tf.loadModel("E:/MSIT/MSIT 213 NEURAL/python/handwriting recognition/output/" + modelName + "/model.json");
